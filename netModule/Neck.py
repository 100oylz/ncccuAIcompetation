...
class Neck(nn.Module):
    ...
    def createLayer(self):
        ...
        self.up_sample_2=nn.Upsample(scale_factor=2,mode=neck_upsample_mode)
        self.csplayer_2conv_1 = CSPLayer_2Conv(in_channel=self.channel_512_w_r_1, out_channel=self.channel_256_w,
    ...
    def forward(self, x1, x2, x3):
        ...
        x2_upsample=self.convmodule_2(x2_upsample)
